...
namespace WatchIt
{
    ...
    {        
        ...
        public void ResetPanelPosition()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ModProperties:ResetPanelPosition -> Exception: " + e.Message);
            }
        }
        ...
        public void ResetWarningPanelPosition()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ModProperties:ResetWarningPanelPosition -> Exception: " + e.Message);
            }
        }
    }
}
