...
public abstract class Configuration<C> where C : class, new()
{
    ...
    public static C Load()
    {
        if (instance == null)
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] Configuration:Load -> Exception: " + e.Message);
            }
        }
    ...
    public static void Save()
    {
        ...
        {
            Debug.Log("[Watch It! Revisited] Configuration:Save -> Exception: " + e.Message);
        }
    }
    ...
    private static string GetConfigPath()
    {
        ...
        {
            Debug.Log("[Watch It! Revisited] Configuration:GetConfigPath -> ConfigurationPath attribute missing in " + typeof(C).Name);
