...
namespace WatchIt
{
    public class ModManager : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ModManager:Awake -> Exception: " + e.Message);
            }
        }
        ...
        public void Start()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ModManager:Start -> Exception: " + e.Message);
            }
        }
        ...
        public void Update()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ModManager:Update -> Exception: " + e.Message);
            }
        }
        ...
        public void OnDestroy()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ModManager:OnDestroy -> Exception: " + e.Message);
            }
        }
        ...
        private void CreateUI()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ModManager:CreateUI -> Exception: " + e.Message);
            }
        }
        ...
        private void UpdateUI()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ModManager:UpdateUI -> Exception: " + e.Message);
            }
        }
    }
}