...
namespace WatchIt.Panels
{
    public class WarningItem
    {
        ...
        public void CreateWarningItem(UIComponent parent, string name, int index, UITextureAtlas atlas)
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] WarningItem:CreateWarningItem -> Exception: " + e.Message);
            }
        }
        ...
        public void DestroyWarningItem()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] WarningItem:DestroyWarningItem -> Exception: " + e.Message);
            }
        }
        ...
        public void Show()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] WarningItem:Show -> Exception: " + e.Message);
            }
        }
        ...
        public void Hide()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] WarningItem:Hide -> Exception: " + e.Message);
            }
        }
        ...
        public void UpdateWarningItem(string sprite, string total)
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] WarningItem:UpdateWarningItem -> Exception: " + e.Message);
            }
        }
    }
}
