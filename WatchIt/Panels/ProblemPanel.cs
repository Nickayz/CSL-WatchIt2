...
namespace WatchIt.Panels
{
    public class ProblemPanel : UIPanel
    {
        ...
        public override void Awake()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ProblemPanel:Awake -> Exception: " + e.Message);
            }
        }
        ...
        public override void Start()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ProblemPanel:Start -> Exception: " + e.Message);
            }
        }
        ...
        public override void Update()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ProblemPanel:Update -> Exception: " + e.Message);
            }
        }
        ...
        public override void OnDestroy()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ProblemPanel:OnDestroy -> Exception: " + e.Message);
            }
        }
        ...
        private void CreateUI()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ProblemPanel:CreateUI -> Exception: " + e.Message);
            }
        }
        ...
        private void UpdateUI()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ProblemPanel:UpdateUI -> Exception: " + e.Message);
            }
        }
        ...
        private void CreateProblems()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ProblemPanel:CreateProblems -> Exception: " + e.Message);
            }
        }
        ...
        private void UpdateProblems()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ProblemPanel:UpdateProblems -> Exception: " + e.Message);
            }
        }
        ...
        private ProblemItem CreateProblem(string name)
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ProblemPanel:CreateProblem -> Exception: " + e.Message);
            }
        ...
        private void RefreshProblems()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] ProblemPanel:RefreshProblems -> Exception: " + e.Message);
            }
        }
    }
}
