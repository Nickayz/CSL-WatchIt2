...
namespace WatchIt.Panels
{
    public class LimitItem
    {
        ...
        public void CreateLimitItem(UIComponent parent, string name, int index)
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] LimitItem:CreateLimitItem -> Exception: " + e.Message);
            }
        }
        ...
        public void DestroyLimitItem()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] LimitItem:DestroyLimitItem -> Exception: " + e.Message);
            }
        }
        ...
        public void UpdateLimitItem()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] LimitItem:UpdateLimitItem -> Exception: " + e.Message);
            }
        }
        ...
        private void GetAmountAndCapacity(string name, out int amount, out int capacity, out bool modded)
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] LimitItem:GetAmountAndCapacity -> Exception: " + e.Message);
