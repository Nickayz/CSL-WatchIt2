...
namespace WatchIt.Panels
{
    public class LimitPanel : UIPanel
    {
        ...
        public override void Awake()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] LimitPanel:Awake -> Exception: " + e.Message);
            }
        }
        ...
        public override void Start()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] LimitPanel:Start -> Exception: " + e.Message);
            }
        }
        ...
        public override void Update()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] LimitPanel:Update -> Exception: " + e.Message);
            }
        }
        ...
        public override void OnDestroy()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] LimitPanel:OnDestroy -> Exception: " + e.Message);
            }
        }
        ...
        private void CreateUI()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] LimitPanel:CreateUI -> Exception: " + e.Message);
            }
        }
        ...
        private void UpdateUI()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] LimitPanel:UpdateUI -> Exception: " + e.Message);
            }
        }
        ...
        private void CreateLimits()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] LimitPanel:CreateLimits -> Exception: " + e.Message);
            }
        }
        ...
        private void UpdateLimits()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] LimitPanel:UpdateLimits -> Exception: " + e.Message);
            }
        }
        ...
        private LimitItem CreateLimit(string name)
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] LimitPanel:CreateLimit -> Exception: " + e.Message);
            }
