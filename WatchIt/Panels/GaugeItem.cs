...
namespace WatchIt.Panels
{
    public class GaugeItem
    {
        ...
        public void CreateGaugeItem(UIComponent parent, string name, GaugeType type, int index, UITextureAtlas atlas, string spriteName, string toolTip)
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] GaugeItem:CreateGaugeItem -> Exception: " + e.Message);
            }
        }
        ...
        private void CreateAsAspect(UIComponent parent, bool verticalLayout, bool doubleRibbonLayout, int index, UITextureAtlas atlas, string spriteName, string toolTip)
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] GaugeItem:CreateAsAspect -> Exception: " + e.Message);
            }
        }
        ...
        private void CreateAsPillar(UIComponent parent, bool verticalLayout, bool doubleRibbonLayout, int index, UITextureAtlas atlas, string spriteName, string toolTip)
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] GaugeItem:CreateAsPillar -> Exception: " + e.Message);
            }
        }
        ...
        private void CreateNumericalDigits(UIComponent parent, int anchor, bool verticalLayout, bool doubleRibbonLayout, int index)
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] GaugeItem:CreateNumericalDigits -> Exception: " + e.Message);
            }
        }
        ...
        public void DestroyGaugeItem()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] GaugeItem:DestroyGaugeItem -> Exception: " + e.Message);
            }
        }
        ...
        public void SetInfoMode(string name)
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] GaugeItem:SetInfoMode -> Exception: " + e.Message);
            }
        }
        ...
        public void UpdateGaugeItem()
        {
            ...
            {
                Debug.Log("[Watch It! Revisited] GaugeItem:UpdateGaugeItem -> Exception: " + e.Message);
            }
        }
